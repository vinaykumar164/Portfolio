  ...
  return (
    <div>
      <p className="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-soft-dark">
        I'm always open to discussing frontend development projects, UI/UX design collaborations, or partnership opportunities to create engaging and user-friendly web experiences.
      </p>
      <div className="mx-2">
